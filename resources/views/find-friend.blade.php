													...
													<div class="d-flex align-content-center justify-content-between w-100">
														<div class="input-group input-group-merge">
															...
															<form id="authorSearch" autocomplete="false">
																<input type="text" class="form-control" id="authorSearchInput" placeholder="Search For Friends" aria-label="Search..." aria-describedby="author-search">
															</form>
														</div>
													</div>
													<div class="dropdown">
    ...
    function processAction(selector, action, user_id, username)
    {
      ...
      let no = '';
        ...
        no = "Cancel";
            ...
            // In any sceniero we unfollow or remove a follower we are to reload the friends tab
            reloadFriends();
					})
					.catch((err) => {
						console.log(err);
