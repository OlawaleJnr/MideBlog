...
<body>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-6">
              <div class="logo">
                <a href="{{ url('/')}}">
                  <img class="dark-logo" src="{{ asset('assets/images/mide-blog-logo/png/logo-black.png') }}"
                    alt="Mide-logo-black">
                  <img class="light-logo" src="{{ asset('assets/images/mide-blog-logo/png/logo-white.png') }}"
                    alt="Mide-logo-white">
                </a>
              </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="content-block image-rounded">
                                      <div class="post-thumbnail mb--20">
                                        <a href="post-details.html">
                                          <img class="w-100" src="assets/images/others/mega-post-01.jpg"
                                            alt="Post Images">
                                        </a>
                                      </div>
                                      <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">India may require online shops to
                                            hand</a></h5>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-3">
                                    <div class="content-block image-rounded">
                                      <div class="post-thumbnail mb--20">
                                        <a href="post-details.html">
                                          <img class="w-100" src="assets/images/others/mega-post-02.jpg"
                                            alt="Post Images">
                                        </a>
                                      </div>
                                      <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">Lightweight, grippable, and ready
                                            to go.</a></h5>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-3">
                                    <div class="content-block image-rounded">
                                      <div class="post-thumbnail mb--20">
                                        <a href="post-details.html">
                                          <img class="w-100" src="assets/images/others/mega-post-03.jpg"
                                            alt="Post Images">
                                        </a>
                                      </div>
                                      <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">Bold new experience. Same Mac
                                            magic.</a></h5>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-3">
                                    <div class="content-block image-rounded">
                                      <div class="post-thumbnail mb--20">
                                        <a href="post-details.html">
                                          <img class="w-100" src="assets/images/others/mega-post-04.jpg"
                                            alt="Post Images">
                                        </a>
                                      </div>
                                      <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">Creative Game With The New DJI
                                            Mavic Air</a></h5>
                                      </div>
                                    </div>
                                  </div>
                ...
                <ul class="metabar-block">
                  ...
                  <li class="icon">
                    <a href="javascript:void(0)">
                      ...
                      <span class="badge badge-pill badge-dark badge-up">{{ $notification->count() }}</span>
                    </a>
                  </li>
                  <li class="icon"><a href="javascript:void(0)"
                      onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                        class="fal fa-sign-out"></i></a></li>
                  {{-- Logout Form --}}
                  <form id="logout-form" action="{{ route('logout') }}" method="POST">
                    @csrf
                  </form>
                  <li><a href="javascript:void(0)"><img src="{{ Auth::guard('web')->user()->picture }}"
                        alt="{{ Auth::guard('web')->user()->name.' '.'Profile Picture'  }}"></a></li>
                  @elseif(Auth::guard('admin')->check())
                  {{-- Admin Widget--}}
                  <li class="icon"><a href="javascript:void(0)"><i class="fal fa-bookmark"></i></a></li>
                  ...
                  <li><a href="javascript:void(0)"><img
                        src="{{ Auth::guard('admin')->user()->name ? Auth::guard('admin')->user()->name : '' }}"
                        alt="{{  Auth::guard('admin')->user()->name ? Auth::guard('admin')->user()->name . ' ' . 'Avatar' : "" }}"></a>
                  </li>
                  @else
  ...
  <script>
    function refreshNotification() {
          ...
          setInterval(() => {
            axios.get("{{ route('refreshNotification') }}", {
              params : {
                count : notification
              }
            })
            .then((data) => {
              if(data.data.data > notification){
                ...
                if (status == false) {
                  let ping = new Audio();
                  ping.src = "{{ asset('assets/audio/iphone.mp3') }}";
                  ping.play();
                  status = true;
                  reloadFollowers();
                }
